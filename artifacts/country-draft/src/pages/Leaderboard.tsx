...
import { Trophy, ChevronDown, ArrowLeft, Globe, CalendarDays, User, Medal, Trash2, Upload , GlobeIcon, ArrowLeftRight, Search } from "lucide-react";
    ...
    >
      ...
      {isPersonal && onPublish && (
        <Tooltip delayDuration={100}>
          ...
          <TooltipContent side="top">Publish to Global Leaderboard</TooltipContent>
        </Tooltip>
      )}
    </motion.div>
  );
