      ...
      <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5, ease: [0.34, 1.56, 0.64, 1] }} className="space-y-8">
        <div className="flex flex-col items-center">
          <div className="p-2 mb-4">
            <img src="/logo.svg" alt="GeoDrafts Logo" className="w-20 h-20" />
          </div>
          <h1 className="font-serif text-5xl font-bold text-foreground mb-4 tracking-tight">GeoDrafts</h1>
          <p className="text-lg text-muted-foreground max-w-md leading-relaxed">
            Play GeoDrafts, the premier strategic geography game where you draft aspects from real countries to build the ultimate nation. Test your geography knowledge across multiple game modes and difficulty levels!
          </p>
        </div>
...
>>>>>>> fed49a9 (Update title, logo, text copy, and add About page)
...
=======
          <motion.div initial={{ opacity: 0, y: 24 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5, ease: [0.34, 1.56, 0.64, 1] }} className="flex flex-col items-center w-full"><div className="p-2 mb-4"><img src="/logo.svg" alt="GeoDrafts Logo" className="w-16 h-16" /></div><h1 className="font-serif text-5xl font-bold text-foreground mb-2 tracking-tight">GeoDrafts</h1><p className="text-base text-muted-foreground mb-8 text-center max-w-md">Play GeoDrafts, the premier strategic geography game where you draft aspects from real countries to build the ultimate nation. Test your geography knowledge across multiple game modes and difficulty levels!</p>
