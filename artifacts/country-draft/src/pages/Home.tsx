    ...
    <div className="flex-1 flex flex-col items-center justify-center px-6 py-12 max-w-xl mx-auto w-full text-center">
      <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5, ease: [0.34, 1.56, 0.64, 1] }} className="space-y-8">
        <div className="flex flex-col items-center">
          <img src="/logo.svg" alt="GeoDrafts Logo" className="w-24 h-24 mb-6 rounded-full object-cover" />
    ...
    <div className="min-h-screen bg-background flex flex-col">
      ...
      {!firebaseUser ? (
        ...
        <div className="flex-1 flex flex-col items-center justify-center px-6 py-12 max-w-3xl mx-auto w-full">
          <motion.div initial={{ opacity: 0, y: 24 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5, ease: [0.34, 1.56, 0.64, 1] }} className="flex flex-col items-center w-full"><img src="/logo.svg" alt="GeoDrafts Logo" className="w-24 h-24 mb-6 rounded-full object-cover" /><h1 className="font-serif text-5xl font-bold text-foreground mb-2 tracking-tight">GeoDrafts</h1><p className="text-base text-muted-foreground mb-8 text-center max-w-md">Play GeoDrafts, the premier strategic geography game where you draft aspects from real countries to build the ultimate nation. Test your geography knowledge across multiple game modes and difficulty levels!</p>
