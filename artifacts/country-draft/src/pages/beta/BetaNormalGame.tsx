...
import { SubmitDialog } from "../normal/SubmitDialog";
...
export default function BetaNormalGame() {
  ...
  const bonus = useMemo(() => computeBetaSizePopBonus(state.roster), [state.roster]);
